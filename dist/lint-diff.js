...
(0, _lintDiff2.default)(cli.input[0], cli.flags.ext, cli.flags.formatter);
...
}), (0, _map3.default)(_path2.default.resolve));
...
var logResults = function logResults(results) {
  return (0, _pipe3.default)((0, _prop3.default)('results'), formatter, console.log)(results);
};
...
var run = function run() {
  ...
  var _extensions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '.js';

  var _formatter = arguments[2];
